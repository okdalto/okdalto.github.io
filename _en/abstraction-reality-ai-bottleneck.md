...
<figure>
<img src="/assets/2026-09-14-abstraction-reality-ai-bottleneck/navier-stokes-equations.jpg" alt="The Navier–Stokes equations over a swirling fluid">
<figcaption markdown="span">Whether the three-dimensional solutions of the Navier–Stokes equations always exist and remain smooth is one of the [Millennium Prize Problems](https://www.claymath.org/millennium/navier-stokes-equation/). Source: [OpenAI](https://openai.com/index/navier-stokes-solution/)</figcaption>
</figure>
