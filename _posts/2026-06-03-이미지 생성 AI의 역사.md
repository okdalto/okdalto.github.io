...
![VAE 시절의 흐릿한 흑백 숫자](/assets/2026-06-03-image-gen-history/vae.jpg)
*초기 생성 모델 시절의 느낌 — 작고 흐릿한 흑백 숫자. 왼쪽이 실제 손글씨 숫자, 오른쪽이 잠재변수 모델이 '생성'한 흐릿한 결과다(여기선 PCA 잠재공간 샘플링으로 재현). 논문: [Auto-Encoding Variational Bayes (Kingma & Welling, 2013)](https://arxiv.org/abs/1312.6114)*
